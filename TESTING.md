...
lint and `assembleRelease` green; the instrumented suite **21/21 green** on
the Pixel_9a emulator (including the detail-scroll regression test). The
manual checklist in §4 was also completed in full the same day.
